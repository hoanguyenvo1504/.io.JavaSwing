...
public class PanelTimKiemSanPham extends javax.swing.JPanel {
    ...
    private String header[] = {"Mã Sản phẩm", "Loại sản phẩm", "Tên sản phẩm", "Đơn giá"};
    ...
    private void initComponents() {
        ...
        cb_timkiempanel_phanloai.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Mã sản phẩm", "Loại sản phẩm", "Tên sản phẩm", "Đơn giá" }));
    ...
    private void btn_timActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_timActionPerformed
        if (cb_timkiempanel_phanloai.getSelectedItem().toString().equals("Mã sản phẩm")) {
            String sql = "SELECT * FROM sanpham WHERE masanpham LIKE '%" + txt_timkiem.getText() + "%'";
            this.selectDataFromDanhBa(sql);

        } else if (cb_timkiempanel_phanloai.getSelectedItem().toString().equals("Loại sản phẩm")) {
            String sql = "SELECT * FROM sanpham WHERE loai LIKE '%" + txt_timkiem.getText() + "%'";
            this.selectDataFromDanhBa(sql);
        } else if (cb_timkiempanel_phanloai.getSelectedItem().toString().equals("Tên sản phẩm")) {
            String sql = "SELECT * FROM sanpham WHERE tensanpham LIKE '%" + txt_timkiem.getText() + "%'";
            this.selectDataFromDanhBa(sql);
        }else if (cb_timkiempanel_phanloai.getSelectedItem().toString().equals("Đơn giá")) {
            String sql = "SELECT * FROM sanpham WHERE dongia LIKE '%" + txt_timkiem.getText() + "%'";
            this.selectDataFromDanhBa(sql);
        }
